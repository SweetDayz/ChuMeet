      			...
      			<div class="col-md-11">
      				...
      				<div class="warningText" id="w3">　</div>
      					      ...
      					      <div class="margin-top-10">
       					      <span class="catadiv">
								<input id="sports" class="checkbox-custom" name="pois" type="checkbox">
								<label for="sports" value="1">運動</label>
							  </span>
       					      <span class="catadiv">
								<input id="learning" class="checkbox-custom" name="pois" type="checkbox">
								<label for="learning" value="3">學習</label>
							  </span>
       					      <span class="catadiv">
								<input id="eat" class="checkbox-custom" name="pois" type="checkbox">
								<label for="eat" value="4">餐聚</label>
							  </span>
       					      <span class="catadiv">
								<input id="arts" class="checkbox-custom" name="pois" type="checkbox">
								<label for="arts" value="5">藝文</label>
							  </span>
       					      <span class="catadiv">
								<input id="movie" class="checkbox-custom" name="pois" type="checkbox">
								<label for="movie" value="6">電影</label>
							  </span>
       					      <span class="catadiv">
								<input id="game" class="checkbox-custom" name="pois" type="checkbox">
								<label for="game" value="7">電競</label>
							  </span>
       					      <span class="catadiv">
								<input id="outdoors" class="checkbox-custom" name="pois" type="checkbox">
								<label for="outdoors" value="9">戶外</label>
							  </span>
       					      <span class="catadiv">
								<input id="pets" class="checkbox-custom" name="pois" type="checkbox">
								<label for="pets" value="10">寵物</label>
							  </span>
       					      <span class="catadiv">
								<input id="others" class="checkbox-custom" name="pois" type="checkbox">
