...
//					     start for each loop
					    ...
					    while(q<15 && q<=Jarray.size()) {
					    	try {
					    	JsonElement obj=Jarray.get(j); 
					    	System.out.println("start a new obj: "+j);
	...
	//								String actContent=actg.getDescriptionFilterHtml();
									...
									String json2 = actJSON.readUrl("http://zip5.5432.tw/zip5json.py?adrs="+actAdr);
